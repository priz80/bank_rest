...
- [Документация API](#документация-api)
  ...
  - [🃏 Карты (доступно для USER и ADMIN)](#-карты-доступно-для-user-и-admin)
      ...
      - [Создать новую карту для текущего пользователя.](#создать-новую-карту-для-текущего-пользователя)
      - [Получить карту по ID.](#получить-карту-по-id)
      - [Заблокировать карту.](#заблокировать-карту)
      - [Активировать карту.](#активировать-карту)
      - [Удалить карту (только если статус ≠ ACTIVE и баланс = 0).](#удалить-карту-только-если-статус--active-и-баланс--0)
  ...
  - [Токен получем при входе.](#токен-получем-при-входе)
